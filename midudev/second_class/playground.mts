...
// HTMLCanvasElement si se encuentra el elemento

// ?? Cómo sabe TypeScript que canvas es de tipo HTMLCanvasElement?
...
const API_URL_GITHUB =
  "https://api.github.com/search/repositories?q=typescript";

const res = await fetch(API_URL_GITHUB);

if (!res.ok) throw new Error("Error al hacer la petición");
